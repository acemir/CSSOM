...
CSSOM.CSSKeyframesRule = function CSSKeyframesRule() {
	...
	// Override cssRules.push to automatically update indexed access
	var self = this;
	var originalPush = this.cssRules.push;
	this.cssRules.push = function() {
		var result = originalPush.apply(this, arguments);
		self._setupIndexedAccess();
		return result;
	};
	
	// Override cssRules.splice to automatically update indexed access
	var originalSplice = this.cssRules.splice;
	this.cssRules.splice = function() {
