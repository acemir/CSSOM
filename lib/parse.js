...
CSSOM.parse = function parse(token, opts, errorHandler) {
	...
	*/
	...
	var quotedNewlineRegExp = regexPatterns.quotedNewlineRegExp;
	...
	function isValidSelectorText(selectorText) {
		...
		// Reset lastIndex to ensure fresh start (regex has /g flag and is shared)
		quotedNewlineRegExp.lastIndex = 0;
		var match;
